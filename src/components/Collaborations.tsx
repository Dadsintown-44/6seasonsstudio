    ...
    <section className="py-20 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <motion.h2 
          ...
          className="text-3xl md:text-4xl font-serif text-gray-800 mb-16 flex items-center justify-center before:content-[''] before:h-[1px] before:w-8 md:before:w-12 before:bg-gray-300 before:mr-4 md:before:mr-6 after:content-[''] after:h-[1px] after:w-8 md:after:w-12 after:bg-gray-300 after:ml-4 md:after:ml-6 text-balance"
        >
          Our Collaborations
        </motion.h2>
